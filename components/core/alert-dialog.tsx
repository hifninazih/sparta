...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 border-2 border-black bg-white p-6 shadow-[8px_8px_0px_rgba(0,0,0,1)] duration-200 rounded-xl sm:rounded-2xl",
        // Animasi Neo-Brutalism: Pop dari tengah
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("text-xl font-black tracking-tight text-black", className)}
    {...props}
  />
))
